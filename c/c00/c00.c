...
/*   Updated: 2026/02/12 14:10:30 by lucas            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//void	ft_print_alphabet(void){char l='a';while(l<='z')ft_putchar(l++);}
//void	ft_print_reverse_alphabet(void){char l='z';while(l>='a')ft_putchar(l--);}
//void	ft_print_numbers(void){int n='0';while(n<='9')ft_putchar(n++);}
//void	ft_is_negative(int n){ft_putchar(n>=0?'P':'N');}
